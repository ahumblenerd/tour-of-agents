...
export const pydanticAi: FrameworkComparison = {
  ...
  references: {
    officialSite: "https://ai.pydantic.dev/",
    docs: "https://ai.pydantic.dev/",
    github: "https://github.com/pydantic/pydantic-ai",
    introBlog: "https://pydantic.dev/articles/pydantic-ai-v1",
    mcpRelevant: true,
    notable: [
      {
        title: "Pydantic launches model-agnostic AI agent platform — VentureBeat",
        url: "https://venturebeat.com/programming-development/python-data-validator-pydantic-launches-model-agnostic-ai-agent-development-platform",
        description: "Independent press coverage of the PydanticAI launch from VentureBeat.",
      },
      {
        title: "Type-safe LLM agents with PydanticAI — Paul Simmering",
        url: "https://simmering.dev/blog/pydantic-ai/",
        description: "Engineer write-up evaluating PydanticAI's type-safety in real use.",
      },
    ],
  },
};
